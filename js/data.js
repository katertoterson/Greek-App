var Data = (function() {
  ...
  var lessons = [
      ...
      exercises: [
        {
          ...
          cards: [
            ...
            { html: '<p>The six principal parts of <span class="greek" style="font-size:22px">κελεύω</span> (order, command):</p><table class="intro-table"><tr><th>#</th><th>Form</th><th>Identification</th></tr><tr><td>I</td><td class="greek">κελεύω</td><td>Present Ind. Act.</td></tr><tr><td>II</td><td class="greek">κελεύσω</td><td>Future Ind. Act.</td></tr><tr><td>III</td><td class="greek">ἐκέλευσα</td><td>Aorist Ind. Act.</td></tr><tr><td>IV</td><td class="greek">κεκέλευκα</td><td>Perfect Ind. Act.</td></tr><tr><td>V</td><td class="greek">κεκέλευσμαι</td><td>Perfect Ind. Pass.</td></tr><tr><td>VI</td><td class="greek">ἐκελεύσθην</td><td>Aorist Ind. Pass.</td></tr></table>' },
            { html: '<p>The six principal parts of <span class="greek" style="font-size:22px">λύω</span> (unbind, free, destroy):</p><table class="intro-table"><tr><th>#</th><th>Form</th><th>Identification</th></tr><tr><td>I</td><td class="greek">λύω</td><td>Present Ind. Act.</td></tr><tr><td>II</td><td class="greek">λύσω</td><td>Future Ind. Act.</td></tr><tr><td>III</td><td class="greek">ἔλῡσα</td><td>Aorist Ind. Act.</td></tr><tr><td>IV</td><td class="greek">λέλυκα</td><td>Perfect Ind. Act.</td></tr><tr><td>V</td><td class="greek">λέλυμαι</td><td>Perfect Ind. Pass.</td></tr><tr><td>VI</td><td class="greek">ἐλύθην</td><td>Aorist Ind. Pass.</td></tr></table>' },
            { html: '<p>The six principal parts of <span class="greek" style="font-size:22px">πέμπω</span> (send):</p><table class="intro-table"><tr><th>#</th><th>Form</th><th>Identification</th></tr><tr><td>I</td><td class="greek">πέμπω</td><td>Present Ind. Act.</td></tr><tr><td>II</td><td class="greek">πέμψω</td><td>Future Ind. Act.</td></tr><tr><td>III</td><td class="greek">ἔπεμψα</td><td>Aorist Ind. Act.</td></tr><tr><td>IV</td><td class="greek">πέπομφα</td><td>Perfect Ind. Act.</td></tr><tr><td>V</td><td class="greek">πέπεμμαι</td><td>Perfect Ind. Pass.</td></tr><tr><td>VI</td><td class="greek">ἐπέμφθην</td><td>Aorist Ind. Pass.</td></tr></table>' },
    ...
    // Lesson 39: Vocabulary I (Verbs & Particles)
    {
      ...
      exercises: [
        { type: 'intro', title: 'New Verbs', cards: [
          { html: '<p>The six principal parts of <span class="greek" style="font-size:22px">γράφω</span> (write, draw):</p><table class="intro-table"><tr><th>#</th><th>Form</th><th>Identification</th></tr><tr><td>I</td><td class="greek">γράφω</td><td>Present Ind. Act.</td></tr><tr><td>II</td><td class="greek">γράψω</td><td>Future Ind. Act.</td></tr><tr><td>III</td><td class="greek">ἔγραψα</td><td>Aorist Ind. Act.</td></tr><tr><td>IV</td><td class="greek">γέγραφα</td><td>Perfect Ind. Act.</td></tr><tr><td>V</td><td class="greek">γέγραμμαι</td><td>Perfect Ind. Pass.</td></tr><tr><td>VI</td><td class="greek">ἐγράφην</td><td>Aorist Ind. Pass.</td></tr></table><p style="font-size:13px;color:var(--text-dim);margin-top:8px">Originally meant "scratch" or "graze"</p>' },
          { html: '<p>The six principal parts of <span class="greek" style="font-size:22px">θύω</span> (sacrifice):</p><table class="intro-table"><tr><th>#</th><th>Form</th><th>Identification</th></tr><tr><td>I</td><td class="greek">θύω</td><td>Present Ind. Act.</td></tr><tr><td>II</td><td class="greek">θύσω</td><td>Future Ind. Act.</td></tr><tr><td>III</td><td class="greek">ἔθῡσα</td><td>Aorist Ind. Act.</td></tr><tr><td>IV</td><td class="greek">τέθυκα</td><td>Perfect Ind. Act.</td></tr><tr><td>V</td><td class="greek">τέθυμαι</td><td>Perfect Ind. Pass.</td></tr><tr><td>VI</td><td class="greek">ἐτύθην</td><td>Aorist Ind. Pass.</td></tr></table><p style="font-size:13px;color:var(--text-dim);margin-top:8px">Note: reduplication shows τ- not θ- (dissimilation of aspirates)</p>' },
          { html: '<p>The six principal parts of <span class="greek" style="font-size:22px">παύω</span> (make stop, stop):</p><table class="intro-table"><tr><th>#</th><th>Form</th><th>Identification</th></tr><tr><td>I</td><td class="greek">παύω</td><td>Present Ind. Act.</td></tr><tr><td>II</td><td class="greek">παύσω</td><td>Future Ind. Act.</td></tr><tr><td>III</td><td class="greek">ἔπαυσα</td><td>Aorist Ind. Act.</td></tr><tr><td>IV</td><td class="greek">πέπαυκα</td><td>Perfect Ind. Act.</td></tr><tr><td>V</td><td class="greek">πέπαυμαι</td><td>Perfect Ind. Pass.</td></tr><tr><td>VI</td><td class="greek">ἐπαύθην</td><td>Aorist Ind. Pass.</td></tr></table><p style="font-size:13px;color:var(--text-dim);margin-top:8px">English "pause" comes from this verb</p>' },
          { html: '<p>The six principal parts of <span class="greek" style="font-size:22px">φυλάττω</span> (guard):</p><table class="intro-table"><tr><th>#</th><th>Form</th><th>Identification</th></tr><tr><td>I</td><td class="greek">φυλάττω</td><td>Present Ind. Act.</td></tr><tr><td>II</td><td class="greek">φυλάξω</td><td>Future Ind. Act.</td></tr><tr><td>III</td><td class="greek">ἐφύλαξα</td><td>Aorist Ind. Act.</td></tr><tr><td>IV</td><td class="greek">πεφύλαχα</td><td>Perfect Ind. Act.</td></tr><tr><td>V</td><td class="greek">πεφύλαγμαι</td><td>Perfect Ind. Pass.</td></tr><tr><td>VI</td><td class="greek">ἐφυλάχθην</td><td>Aorist Ind. Pass.</td></tr></table><p style="font-size:13px;color:var(--text-dim);margin-top:8px">PP IV has an aspirated perfect; note dissimilation of aspirates</p>' }
        ]},
    ...
    // Lesson 58: First Declension Short -α
    {
      ...
      exercises: [
        { type: 'intro', title: 'First Declension: Short -α', cards: [
          ...
          { html: '<h3>Singular<br>-η type, Nom./Acc. → Short: -α/-αν</h3><table class="intro-table"><tr><th></th><th class="greek">θάλαττα</th><th class="greek">μοῦσα</th></tr><tr><td>Nom.</td><td class="greek">θάλαττα</td><td class="greek">μοῦσα</td></tr><tr><td>Gen.</td><td class="greek">θαλάττης</td><td class="greek">μούσης</td></tr><tr><td>Dat.</td><td class="greek">θαλάττῃ</td><td class="greek">μούσῃ</td></tr><tr><td>Acc.</td><td class="greek">θάλατταν</td><td class="greek">μοῦσαν</td></tr></table><h3 style="margin-top:12px">Gen./Dat. → Long -ᾱς/-ᾳ<br><span style="font-size:13px;font-weight:normal;color:var(--text-dim)">(Stem ends in ε/ι/ρ)</span></h3><table class="intro-table"><tr><th></th><th class="greek">γέφῡρα</th><th class="greek">μοῖρα</th></tr><tr><td>Nom.</td><td class="greek">γέφῡρα</td><td class="greek">μοῖρα</td></tr><tr><td>Gen.</td><td class="greek">γεφύρᾱς</td><td class="greek">μοίρᾱς</td></tr><tr><td>Dat.</td><td class="greek">γεφύρᾳ</td><td class="greek">μοίρᾳ</td></tr><tr><td>Acc.</td><td class="greek">γέφῡραν</td><td class="greek">μοῖραν</td></tr></table>' },
          { html: '<h3>Plural</h3><table class="intro-table"><tr><th></th><th class="greek">θάλατται</th><th class="greek">μοῦσαι</th></tr><tr><td>Nom.</td><td class="greek">θάλατται</td><td class="greek">μοῦσαι</td></tr><tr><td>Gen.</td><td class="greek">θαλαττῶν</td><td class="greek">μουσῶν</td></tr><tr><td>Dat.</td><td class="greek">θαλάτταις</td><td class="greek">μούσαις</td></tr><tr><td>Acc.</td><td class="greek">θαλάττᾱς</td><td class="greek">μούσᾱς</td></tr></table><table class="intro-table" style="margin-top:12px"><tr><th></th><th class="greek">γέφῡραι</th><th class="greek">μοῖραι</th></tr><tr><td>Nom.</td><td class="greek">γέφῡραι</td><td class="greek">μοῖραι</td></tr><tr><td>Gen.</td><td class="greek">γεφῡρῶν</td><td class="greek">μοιρῶν</td></tr><tr><td>Dat.</td><td class="greek">γεφύραις</td><td class="greek">μοίραις</td></tr><tr><td>Acc.</td><td class="greek">γεφύρᾱς</td><td class="greek">μοίρᾱς</td></tr></table><p>As in all first-declension nouns, the <strong>genitive plural</strong> receives a circumflex on the ultima.</p>' }
        ]},
    ...
    // Lesson 60: First Declension Masculine
    {
      ...
      exercises: [
        { type: 'intro', title: 'Masculine First-Declension Nouns', cards: [
          ...
          { html: '<h3>Singular -ης type</h3><table class="intro-table"><tr><th></th><th class="greek">πολίτης</th><th class="greek">ποιητής</th></tr><tr><td>Nom.</td><td class="greek">πολίτης</td><td class="greek">ποιητής</td></tr><tr><td>Gen.</td><td class="greek">πολίτου</td><td class="greek">ποιητοῦ</td></tr><tr><td>Dat.</td><td class="greek">πολίτῃ</td><td class="greek">ποιητῇ</td></tr><tr><td>Acc.</td><td class="greek">πολίτην</td><td class="greek">ποιητήν</td></tr><tr><td>Voc.</td><td class="greek">πολῖτα</td><td class="greek">ποιητά</td></tr></table><h3 style="margin-top:12px">Singular -ᾱς type<br><span style="font-size:13px;font-weight:normal;color:var(--text-dim)">(Stem ends in ε/ι/ρ)</span></h3><table class="intro-table"><tr><th></th><th class="greek">νεᾱνίᾱς</th></tr><tr><td>Nom.</td><td class="greek">νεᾱνίᾱς</td></tr><tr><td>Gen.</td><td class="greek">νεᾱνίου</td></tr><tr><td>Dat.</td><td class="greek">νεᾱνίᾳ</td></tr><tr><td>Acc.</td><td class="greek">νεᾱνίᾱν</td></tr><tr><td>Voc.</td><td class="greek">νεᾱνίᾱ</td></tr></table>' },
          { html: '<h3>Plural (-ης type)</h3><table class="intro-table"><tr><th></th><th class="greek">πολῑται</th><th class="greek">ποιηταί</th></tr><tr><td>Nom./Voc.</td><td class="greek">πολῑται</td><td class="greek">ποιηταί</td></tr><tr><td>Gen.</td><td class="greek">πολῑτῶν</td><td class="greek">ποιητῶν</td></tr><tr><td>Dat.</td><td class="greek">πολίταις</td><td class="greek">ποιηταῖς</td></tr><tr><td>Acc.</td><td class="greek">πολίτᾱς</td><td class="greek">ποιητάς</td></tr></table><table class="intro-table" style="margin-top:12px"><tr><th></th><th class="greek">νεᾱνίαι</th></tr><tr><td>Nom./Voc.</td><td class="greek">νεᾱνίαι</td></tr><tr><td>Gen.</td><td class="greek">νεᾱνιῶν</td></tr><tr><td>Dat.</td><td class="greek">νεᾱνίαις</td></tr><tr><td>Acc.</td><td class="greek">νεᾱνίᾱς</td></tr></table><p>As in all first-declension nouns, the genitive plural takes a circumflex on the ultima.</p>' },
    ...
    // Lesson 61: Three-Ending Adjectives
    {
      ...
      exercises: [
        { type: 'intro', title: 'Three-Ending Adjectives', cards: [
          ...
          { html: '<h3>New Adjectives (1/2)</h3><div class="vocab-card"><div class="vocab-greek">ἀγαθός, ἀγαθή, ἀγαθόν</div><div class="vocab-english">good</div><div class="vocab-gender">combines moral goodness & serviceability</div></div><div class="vocab-card"><div class="vocab-greek">κακός, κακή, κακόν</div><div class="vocab-english">bad, evil</div></div><div class="vocab-card"><div class="vocab-greek">καλός, καλή, καλόν</div><div class="vocab-english">beautiful, noble, good</div><div class="vocab-gender">combines physical beauty & moral goodness</div></div>' },
          { html: '<h3>New Adjectives (2/2)</h3><div class="vocab-card"><div class="vocab-greek">δίκαιος, δικαίᾱ, δίκαιον</div><div class="vocab-english">just</div><div class="vocab-gender">from δίκη (justice)</div></div><div class="vocab-card"><div class="vocab-greek">ἄξιος, ἀξίᾱ, ἄξιον</div><div class="vocab-english">worthy, worth (+ gen.)</div><div class="vocab-gender">takes genitive of value</div></div><div class="vocab-card"><div class="vocab-greek">φίλος, φίλη, φίλον</div><div class="vocab-english">dear, beloved</div><div class="vocab-gender">identical to the noun φίλος (friend) in masculine</div></div>' },
    ...
    // Lesson 62: Two-Ending Adjectives
    {
      ...
      exercises: [
        { type: 'intro', title: 'Two-Ending Adjectives', cards: [
          ...
          { html: '<h3 class="greek">ἄδικος, ἄδικον — unjust</h3><h4>Singular</h4><table class="intro-table"><tr><th></th><th>M/F</th><th>N</th></tr><tr><td>Nom.</td><td class="greek">ἄδικος</td><td class="greek">ἄδικον</td></tr><tr><td>Gen.</td><td class="greek">ἀδίκου</td><td class="greek">ἀδίκου</td></tr><tr><td>Dat.</td><td class="greek">ἀδίκῳ</td><td class="greek">ἀδίκῳ</td></tr><tr><td>Acc.</td><td class="greek">ἄδικον</td><td class="greek">ἄδικον</td></tr></table><h4 style="margin-top:12px">Plural</h4><table class="intro-table"><tr><th></th><th>M/F</th><th>N</th></tr><tr><td>Nom./Voc.</td><td class="greek">ἄδικοι</td><td class="greek">ἄδικα</td></tr><tr><td>Gen.</td><td class="greek">ἀδίκων</td><td class="greek">ἀδίκων</td></tr><tr><td>Dat.</td><td class="greek">ἀδίκοις</td><td class="greek">ἀδίκοις</td></tr><tr><td>Acc.</td><td class="greek">ἀδίκους</td><td class="greek">ἄδικα</td></tr></table>' },
    ...
    // Lesson 63: Adjective Position
    {
      ...
      exercises: [
        { type: 'intro', title: 'Adjective Position', cards: [
          ...
          { html: '<h3>Without an Article</h3><p>The attributive vs. predicate distinction <strong>only applies when an article is present</strong>.</p><p>When there is <strong>no article at all</strong>, an adjective next to a noun is simply modifying it — it is attributive by default.</p><table class="intro-table"><tr><th>Greek</th><th>Translation</th></tr><tr><td class="greek">ἀγαθὸν βιβλίον</td><td>a good book</td></tr><tr><td class="greek">καλὰ ζῷα</td><td>beautiful animals</td></tr></table><p>Without an article, there is no article-noun group for the adjective to stand outside of, so the predicate reading does not arise.</p>' }
        ]},
    ...
    // Lesson 69: Vocabulary III (Verbs & Particles)
    {
      ...
      exercises: [
        { type: 'intro', title: 'New Verbs', cards: [
          { html: '<p>The six principal parts of <span class="greek" style="font-size:22px">διδάσκω</span> (teach):</p><table class="intro-table"><tr><th>#</th><th>Form</th><th>Identification</th></tr><tr><td>I</td><td class="greek">διδάσκω</td><td>Present Ind. Act.</td></tr><tr><td>II</td><td class="greek">διδάξω</td><td>Future Ind. Act.</td></tr><tr><td>III</td><td class="greek">ἐδίδαξα</td><td>Aorist Ind. Act.</td></tr><tr><td>IV</td><td class="greek">δεδίδαχα</td><td>Perfect Ind. Act.</td></tr><tr><td>V</td><td class="greek">δεδίδαγμαι</td><td>Perfect Ind. Pass.</td></tr><tr><td>VI</td><td class="greek">ἐδιδάχθην</td><td>Aorist Ind. Pass.</td></tr></table><p style="font-size:13px;color:var(--text-dim);margin-top:8px">Narrower than παιδεύω; takes the same constructions</p>' },
          { html: '<p>The six principal parts of <span class="greek" style="font-size:22px">ἐθέλω</span> (be willing, wish):</p><table class="intro-table"><tr><th>#</th><th>Form</th><th>Identification</th></tr><tr><td>I</td><td class="greek">ἐθέλω</td><td>Present Ind. Act.</td></tr><tr><td>II</td><td class="greek">ἐθελήσω</td><td>Future Ind. Act.</td></tr><tr><td>III</td><td class="greek">ἠθέλησα</td><td>Aorist Ind. Act.</td></tr><tr><td>IV</td><td class="greek">ἠθέληκα</td><td>Perfect Ind. Act.</td></tr><tr><td>V</td><td class="greek">———</td><td>Perfect Ind. Pass.</td></tr><tr><td>VI</td><td class="greek">———</td><td>Aorist Ind. Pass.</td></tr></table><p style="font-size:13px;color:var(--text-dim);margin-top:8px">The ἐ- is part of the stem (not an augment); augment lengthens it to ἠ-. Takes object infinitive. οὐκ ἐθέλω = "refuse"</p>' },
          { html: '<p>The six principal parts of <span class="greek" style="font-size:22px">θάπτω</span> (bury):</p><table class="intro-table"><tr><th>#</th><th>Form</th><th>Identification</th></tr><tr><td>I</td><td class="greek">θάπτω</td><td>Present Ind. Act.</td></tr><tr><td>II</td><td class="greek">θάψω</td><td>Future Ind. Act.</td></tr><tr><td>III</td><td class="greek">ἔθαψα</td><td>Aorist Ind. Act.</td></tr><tr><td>IV</td><td class="greek">———</td><td>Perfect Ind. Act.</td></tr><tr><td>V</td><td class="greek">τέθαμμαι</td><td>Perfect Ind. Pass.</td></tr><tr><td>VI</td><td class="greek">ἐτάφην</td><td>Aorist Ind. Pass.</td></tr></table><p style="font-size:13px;color:var(--text-dim);margin-top:8px">Labial stem (π before τ → πτ)</p>' },
          { html: '<p>The six principal parts of <span class="greek" style="font-size:22px">τάττω</span> (draw up in order, station, appoint):</p><table class="intro-table"><tr><th>#</th><th>Form</th><th>Identification</th></tr><tr><td>I</td><td class="greek">τάττω</td><td>Present Ind. Act.</td></tr><tr><td>II</td><td class="greek">τάξω</td><td>Future Ind. Act.</td></tr><tr><td>III</td><td class="greek">ἔταξα</td><td>Aorist Ind. Act.</td></tr><tr><td>IV</td><td class="greek">τέταχα</td><td>Perfect Ind. Act.</td></tr><tr><td>V</td><td class="greek">τέταγμαι</td><td>Perfect Ind. Pass.</td></tr><tr><td>VI</td><td class="greek">ἐτάχθην</td><td>Aorist Ind. Pass.</td></tr></table><p style="font-size:13px;color:var(--text-dim);margin-top:8px">Velar stem (γ before τ → ττ in Attic)</p>' }
        ]},
        ...
        { type: 'intro', title: 'Prepositions, Particles & Adverb', cards: [
          { html: '<table class="intro-table"><tr><th class="greek">Word</th><th>Meaning</th></tr><tr><td class="greek">μετά + gen.</td><td>with<br><span style="font-size:12px;color:var(--text-dim)">(accompaniment)</span></td></tr><tr><td class="greek">μετά + acc.</td><td>after<br><span style="font-size:12px;color:var(--text-dim)">(in space or time)</span></td></tr><tr><td class="greek">σύν + dat.</td><td>with<br><span style="font-size:12px;color:var(--text-dim)">(joint effort, traditional phrases)</span></td></tr><tr><td class="greek">πάλαι (adv.)</td><td>long ago</td></tr></table><p class="greek" style="font-size:13px">μετὰ τῶν φίλων = with the friends<br>μετὰ τὴν μάχην = after the battle<br>σὺν θεοῖς = with (the help of the) gods</p>' },
          { html: '<table class="intro-table"><tr><th class="greek">Word</th><th>Meaning</th></tr><tr><td class="greek">ἄν</td><td>particle<br><span style="font-size:12px;color:var(--text-dim)">(not separately translated)</span></td></tr><tr><td class="greek">εἰ</td><td>if<br><span style="font-size:12px;color:var(--text-dim)">(with optative or indicative)</span></td></tr><tr><td class="greek">ἐάν</td><td>if<br><span style="font-size:12px;color:var(--text-dim)">(= εἰ + ἄν; with subjunctive)</span></td></tr><tr><td class="greek">καίτοι</td><td>and further, and yet</td></tr></table>' }
        ]},
    ...
    // Lesson 71: Unit 4 Review
    {
      ...
      exercises: [
        ...
        { type: 'word-bank', prompt: 'Translate:', display: 'ἐὰν κακοὺς ἀνθρώπους εἰς πόλεμον πέμψωμεν, ἀγαθοὺς ἀνθρώπους θάψομεν.', displayGreek: true,
          answer: ['if', 'we', 'send', 'bad', 'men', 'into', 'war', 'we', 'will', 'bury', 'good', 'men'],
          distractors: ['sent', 'the', 'battle']
        },
        { type: 'word-bank', prompt: 'Translate:', display: 'ὅπως ἀγαθὸν βιβλίον γράψειεν, ὁ ποιητὴς ὁ δίκαιος τοῖς θεοῖς ζῷα καλὰ ἔθῡεν.', displayGreek: true,
          answer: ['in', 'order', 'that', 'he', 'might', 'write', 'a', 'good', 'book', 'the', 'just', 'poet', 'was', 'sacrificing', 'beautiful', 'animals', 'to', 'the', 'gods'],
          distractors: ['wrote', 'sacrificed', 'unjust']
        },
        { type: 'match', pairs: [
    ...
    // Lesson 80: Agent & Means
    {
      ...
      exercises: [
        ...
        { type: 'mc-translate', prompt: 'In λέλυται δὴ ἡ δημοκρατίᾱ τοῖς ὁπλίταις, why is the dative (τοῖς ὁπλίταις) used instead of ὑπό + gen.?', correct: 'Because the verb is in the perfect tense — dative of personal agent', options: ['Because the verb is in the perfect tense — dative of personal agent', 'Because ὁπλίτης is a military word', 'Because the agent is plural', 'Because it expresses means, not agent'] },
    ...
    // Lesson 82: Substantive Article
    {
      ...
      exercises: [
        { type: 'intro', title: 'Substantive Use of the Article', cards: [
          { html: '<p>The definite article can be used with <strong>an adverb, prepositional phrase, or modifier</strong> to act as a noun:</p><table class="intro-table"><tr><th>Greek</th><th>Meaning</th></tr><tr><td class="greek">οἱ ἐν τῇ νήσῳ</td><td>the <strong>men</strong> on the island</td></tr><tr><td class="greek">τὰς νῦν</td><td>the <strong>women</strong> now /<br>women of the present</td></tr><tr><td class="greek">τὰ τοῦ πολέμου</td><td>the <strong>things</strong> of war<br>(= the affairs of war)</td></tr></table><p style="font-size:13px;color:var(--text-dim);margin-top:8px">The article\'s gender and number indicate who/what is meant; its case shows function in the sentence.</p>' },
    ...
    // Lesson 86: Vocabulary I (3rd Declension Nouns — Paradigm Words)
    {
      ...
      icon: 'φ',
      exercises: [
        { type: 'intro', title: 'Third-Declension Nouns', cards: [
          { html: '<p>So far you\'ve learned 1st declension (ᾱ/η endings) and 2nd declension (ος/ον endings). The <strong>3rd declension</strong> is different:</p><ul style="margin:8px 0;padding-left:20px"><li>The nominative singular varies widely — no single predictable ending</li><li>The <strong>stem</strong> is found by dropping <strong>-ος</strong> from the <strong>genitive singular</strong></li><li>Nouns can be masculine, feminine, or neuter</li></ul><p>This is why Greek dictionaries list the genitive form alongside the nominative — you need it to find the stem!</p><p style="font-size:13px;color:var(--text-dim);margin-top:8px">Example: φύλαξ, φύλακ-ος → stem φυλακ-</p>' },
          { html: '<h3>3rd Declension Endings</h3><table class="intro-table"><tr><th></th><th>M/F</th><th>Neuter</th></tr><tr><td>Nom. S.</td><td>(varies)</td><td>(varies)</td></tr><tr><td>Gen.</td><td>-ος</td><td>-ος</td></tr><tr><td>Dat.</td><td>-ι</td><td>-ι</td></tr><tr><td>Acc.</td><td>-α (or -ν)</td><td>= Nom.</td></tr></table><table class="intro-table" style="margin-top:10px"><tr><th></th><th>M/F</th><th>Neuter</th></tr><tr><td>Nom. P.</td><td>-ες</td><td>-α</td></tr><tr><td>Gen.</td><td>-ων</td><td>-ων</td></tr><tr><td>Dat.</td><td>-σι(ν)</td><td>-σι(ν)</td></tr><tr><td>Acc.</td><td>-ας</td><td>-α</td></tr></table><p style="font-size:13px;color:var(--text-dim);margin-top:8px">These endings attach to the <strong>stem</strong>, not the nominative form.</p>' },
          { html: '<h3>Consonant Stems</h3><p>The nouns in this lesson have stems ending in a <strong>consonant</strong> (κ, γ, δ, τ, etc.). When the stem consonant meets the -σι of the dative plural, sound changes occur:</p><table class="intro-table"><tr><th>Stem ends in</th><th>+ σι =</th><th>Example</th></tr><tr><td>κ, γ, χ</td><td>-ξι</td><td class="greek">φύλαξι(ν)</td></tr><tr><td>τ, δ, θ</td><td>-σι</td><td class="greek">ἐλπίσι(ν)</td></tr></table><p style="font-size:13px;color:var(--text-dim);margin-top:8px">The nominative singular also shows these changes: φυλακ- → φύλαξ (κ + ς = ξ), ἐλπιδ- → ἐλπίς (δ + ς = ς).</p>' }
        ]},
